...
public class LwpolylineTest extends AbstractEntityTest {
    ...
    public void testExtrusion() {
        ...
        assertFalse(lwpolyline.isEmpty());
        assertTrue(lwpolyline.getHeader() > 0);
        Vector3d extrusion = lwpolyline.getExtrusion();
    ...
    public void testPoints() {
        ...
        assertFalse(lwpolyline.isEmpty());
        assertTrue(lwpolyline.getHeader() > 0);
        int numPoints = lwpolyline.getNumPoints();
        assertEquals(2, numPoints);
        List<Point2d> point2ds = lwpolyline.getPoints();
    ...
    public void testVertexids() {
        ...
        assertEquals(0, vertexids);
        lwpolyline.setNumVertexids(2);
    ...
    public void testBulges() {
        ...
        assertFalse(lwpolyline.isEmpty());
        assertTrue(lwpolyline.getHeader() > 0);
        int numBulges = lwpolyline.getNumBulges();
        assertEquals(0, numBulges);
        lwpolyline.setNumBulges(1);
        lwpolyline.setBulges(new ArrayList<>(Collections.singletonList(1.0)));
        numBulges = lwpolyline.getNumBulges();
        assertEquals(1, numBulges);
        List<Double> bulges = lwpolyline.getBulges();
        assertNotNull(bulges);
        assertEquals(1, bulges.size());
        assertEquals(1.0, bulges.get(0), TOLERANCE);
    }
    ...
    public void testWidths() {
        ...
        assertFalse(lwpolyline.isEmpty());
        assertTrue(lwpolyline.getHeader() > 0);
        int numWidths = lwpolyline.getNumWidths();
