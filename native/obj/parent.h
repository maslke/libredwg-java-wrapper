...
JNIEXPORT void  JNICALL Java_io_github_maslke_dwg_entity_Parent_setColor(JNIEnv *, jobject, jlong, jobject);
...
JNIEXPORT jobject JNICALL Java_io_github_maslke_dwg_entity_Parent_getColor(JNIEnv *, jobject, jlong);
